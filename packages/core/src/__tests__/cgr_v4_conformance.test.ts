...
//   2. the 58 vectors — driven in-process with an in-memory `seek` (mirrors bin/verify-v4.mjs).
...
// ── Layer 2: run all 58 vectors in their declared modes ──────────────────────
describe('cgr.attestation.v4 corpus — 58 vectors, both modes', () => {
